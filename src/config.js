...
export const CONFIG = {
  ...
  // ============ 模块定义 ============
  // remote: true 表示该模块数据由后端 REST 接口存取（前后端分离），false 走本地 localStorage。
  modules: [
    { key:"todo", name:"今日头条", icon:"list", tint:"#efeee8", color:"var(--accent)", type:"todo", remote:true, desc:"今日要闻与待办清单",
    ...
    { key:"checkin", name:"习惯日报", icon:"cat", tint:"#eef3ec", color:"var(--module-1)", type:"checkin", remote:true, desc:"每日习惯·连续出刊",
    ...
    { key:"money", name:"财务版", icon:"wallet", tint:"#f6efe8", color:"var(--module-4)", type:"finance", remote:true, desc:"收入·支出·分类·占比",
    ...
    { key:"note", name:"记者手记", icon:"pen", tint:"#f1eef4", color:"var(--module-5)", type:"note", remote:true, desc:"灵感·摘录·心情记录",
